...
PROFILE_DESCRIPTION = (
    ...
    "string hooks plus driver stack-state store deflattening."
)
...
# - string decrypt: valorant_2_6 delegate
#
# Validation:
...
def plan_string_decrypt_calls(bv, func, il, mlil_stable):
    return valorant_2_6.plan_string_decrypt_calls(bv, func, il, mlil_stable)
