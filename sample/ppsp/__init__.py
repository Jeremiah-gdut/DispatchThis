...
def _selector_table_targets(
    ...
    if (
        ...
        or _constant_value(stride_write.src) != getattr(view.arch, "address_size", None)
        or not _same_register(index_extend.dest, index_register)
    ...
    table_base = _evaluate_literal(view.arch, table_load.src, registers, stack_values)
